...
public class Index extends JFrame{
	...
	*/
	...
	public Index() { /*Модификатор доступа public означает, что метод Index()виден и доступен любому классу.
		...
		setSize(300, 280); // указывает ширину (370) и высоту (430).
		...
		panel.setBorder(new EmptyBorder(5,10,30,10));//установка внутренних отступов(5 справа и слева,10сверху и снизу)

		/* установка менеджера компоновки GridLayout. данный менеджер компоновки располагает компоненты в таблицу */
		panel.setLayout(new GridLayout(6,1,10,5));/* на панеле будет 6 строк, 2 столбца, расстояние между
		...
		label_1 = new JLabel("1. Расход топлива на 100 км (л):", JLabel.LEFT);
		label_2 = new JLabel("2. Длина пути (км):", JLabel.LEFT);
		label_3 = new JLabel("3. Цена топлива за литр (руб):", JLabel.LEFT);
		...
		*/
		button = new JButton("Рассчитать стоимость поездки"); //В скобках - надпись на кнопке
	
		rash = new JTextField();
		rash.setToolTipText("Введите расход топлива на 100 км");//всплывающая подсказка при наведении на текстовое поле
		...
		panel_1.add(button);//Добавление кнопки на панель panel_1
		...
		button.addActionListener(new ActionListener()   
      	...
      	*/
    	    {  
    	    	...
    	    	if ((isValidInput(rash, "расход топлива на 100 км")) && 
    	    		(isValidInput(km, "расстояние")) && 
    	    		...
    	    		{
	    	    		d_rash = Double.parseDouble(rash.getText());
	    	    		d_km = Double.parseDouble(km.getText());
	    	    		d_price = Double.parseDouble(price.getText());	
